...
class DataLoader():
    def __init__(self, symbols, start, end, minimal = True, *arg, **karg):
...
# loader3 = DataLoader(symbols='VND', start="2018-01-10", end="2018-02-15", minimal=False)
# loader3 = DataLoader(symbols='VND', start="2018-01-10", end="2018-02-15", minimal=True)
# loader3 = DataLoader(symbols=['VND', 'VCB'], start="2018-01-10", end="2018-02-15", minimal=True)
# loader4 = DataLoader(symbols='VND', start="2018-01-10", end="2018-02-15", minimal=False)
# loader4 = DataLoader(symbols='VND', start="2018-01-10", end="2018-02-15", minimal=True)
# loader4 = DataLoader(symbols=['VND', 'VCB'], start="2018-01-10", end="2018-02-15", minimal=True)